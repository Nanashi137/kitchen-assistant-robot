...
**viable_objects in output:** collect ALL viable candidates from every entity that contributes to ambiguity.
...
{{"classification": "Unambiguous", "ambiguity_type": "None", "viable_objects": ["ceramic bowl"]}}
...
{{"classification": "Unambiguous", "ambiguity_type": "None", "viable_objects": ["clean sponge"]}}
...
{{"classification": "Ambiguous", "ambiguity_type": "Common Sense", "viable_objects": ["large mixing bowl", "tiny dipping bowl"]}}
...
{{"classification": "Ambiguous", "ambiguity_type": "Preferences", "viable_objects": ["blue mug", "red mug"]}}
...
{{"classification": "Ambiguous", "ambiguity_type": "Preferences", "viable_objects": ["dark chocolate tablet", "milk chocolate tablet", "almond milk chocolate tablet"]}}
...
{{"classification": "Ambiguous", "ambiguity_type": "Preferences", "viable_objects": ["dark chocolate tablet", "milk chocolate tablet"]}}
...
{{
  ...
  "viable_objects": ["object1", "object2", ...]
}}
